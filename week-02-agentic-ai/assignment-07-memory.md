...
![Task 1 Screenshot](screenshots/assignment-07-memory-loc.png)
...
![Task 2 Screenshot](screenshots/assignment-07-memory-loc-update.png)

---

#### Screenshot 3 — The `MEMORY.md` file open in VS Code showing the saved content

![Task 2 Screenshot](screenshots/assignment-07-memory-loc-check.png)
...
![Task 3 Screenshot](screenshots/assignment-07-claude-newchat.png)
...
![Task 4 Screenshot](screenshots/assignment-07-claude-newchat.png)

---

#### Screenshot 6 — Claude refusing JavaScript request based on memory rule

![Task 4 Screenshot](screenshots/assignment-07-claude-newchat-memory.png)
...
`https://www.linkedin.com/posts/shivamsharma-builds_developerexperience-devops-infrastructureascode-share-7507311316802359296-ul40`
